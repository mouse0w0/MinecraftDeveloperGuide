...
### 其他开发资料
- [Minecraft 服务端开发指北](https://www.mcbbs.net/thread-1276664-1-1.html)（[备用连接](https://izzel.io/2021/11/13/how-to-minecraft-server/)）
...
### 模组示例代码
- [【1.18.1-1.19.3】McJty的模组示例代码](https://github.com/McJty/TutorialV3)
...
### [Rarity的实例型Bukkit插件开发教程](https://www.mcbbs.net/thread-1163259-1-1.html)

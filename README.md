...
### JDK 下载
- [Oracle JDK](https://www.oracle.com/java/technologies/java-se-glance.html)：Oracle 的 JDK 下载，下载Java17以下的JDK存档需登录，商业使用受限
...
- [Microsoft Build of OpenJDK](https://learn.microsoft.com/zh-cn/java/openjdk/download/)：Microsoft提供的 OpenJDK
